...
| `buildWorkAvailable` | js/pawns.js:125 |
...
| `clinicExists` | js/pawns.js:573 |
| `consider` | js/pawns.js:782 |
...
| `goTo` | js/pawns.js:164 |
| `greedyStep` | js/pawns.js:591 |
| `groundTex` | js/render.js:56 |
| `handleCombat` | js/pawns.js:606 |
...
| `ix` | js/world.js:68 |
| `iy` | js/world.js:69 |
| `jobSkill` | js/pawns.js:556 |
| `jobTarget` | js/pawns.js:172 |
