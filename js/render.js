...
export function createRenderer(world) {
  ...
  var ENEMY_LOOK = {
    ...
    demon:    { idle: demonFrames, walk: demonFrames, scale: 7.875, anchorY: 0.9 }, // 최종 보스=MiniWorld 무장 붉은 악마(31.5→15.75→7.875, 추가로 절반 축소)
    minidemon: { idle: minidemonFrames, walk: minidemonFrames, scale: 5.25, anchorY: 0.9 }, // 미니 악마=MiniWorld 보라 악마(보스와 같은 비율로 절반 축소, 보스의 2/3 크기)
  };
